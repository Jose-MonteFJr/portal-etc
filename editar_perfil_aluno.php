            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a class="btn btn-outline-secondary btn-sm" href="perfil_aluno.php">Cancelar</a>
                    </div>
                    ...
                    <form method="post" action="editar_perfil_aluno.php" class="card shadow-sm p-3" onsubmit="return confirm('Tem certeza que deseja salvar as alterações?');">
                        <?php csrf_input(); ?>
